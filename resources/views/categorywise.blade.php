...
@section('title', 'Category based ad')
                        ...
                        <tr>
                            <td>
                                @foreach($ad_data as $data)
                                    ...
                                    <a value="{{$var=$data->pid}}" href="{{route('viewProductForBooks',['product_id'=>$var])}}">
                                                <div class="card" style="height: 150px;width: 500px;>
                                                    <div class="card bg-light text-dark">
                                                        <div class="card-body">
                        ...
                        <tr>
                            <td>
                                @foreach($ad_data as $data)
                                    ...
                                    <a value="{{$var=$data->pid}}" href="{{route('viewProductForFurniture',['product_id'=>$var])}}">
                                                <div class="card" style="height: 150px;width: 500px;>
                                                    <div class="card bg-light text-dark">
                                                        <div class="card-body">
