                        ...
                        <tr>
                            <td>
                                <table>
                                    ...
                                    <tr>
                                        <td style="font-size: 15px;">
                                        <a href="{{route('Ad.searchByCategory',['category_name'=>'electronics'])}}">Electronics({{$total_electronics}})</a></td>
                                    </tr>
                                    <tr>
                                        <td style="font-size: 15px;">
                                        <a href="{{route('Ad.searchByCategory',['category_name'=>'books'])}}">Books({{$total_books}})</a></td>
                                     </tr>
                                    <tr>
                                        <td style="font-size: 15px;">
                                    ...
                                    <tr>
                                        <td style="font-size: 15px;">
                                        <a href="{{route('Ad.searchByCategory',['category_name'=>'furniture'])}}">Furnitures({{$total_furniture}})</a></td>
                                    </tr>
                                    <tr>
                                        <td style="font-size: 15px;">
                                        <a href="{{route('Ad.searchByCategory',['category_name'=>'property'])}}"></a></td>
                                    </tr>
                                    <tr>
...
<!--                                                 <a value="{{$var=$us->pid}}" href="{{route('viewProductForVehicles',['product_id'=>$var])}}">
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                @elseif ($max_page == $total_vehicles)
                                                     <p style="">{{ $vehicles_data ->links()}}</p>
                                                     
                                                @else
                                                    <p>{{$furniture_data->links() }}</p>
